...
<template>
  <div class="calendar">
        ...
        <svg width="20" height="20" viewBox="0 0 16 16" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
          <g class="transform-group">
            <g transform="scale(0.015625, 0.015625)">
              <path d="M671.968 912c-12.288 0-24.576-4.672-33.952-14.048L286.048 545.984c-18.752-18.72-18.752-49.12 0-67.872l351.968-352c18.752-18.752 49.12-18.752 67.872 0 18.752 18.72 18.752 49.12 0 67.872l-318.016 318.048 318.016 318.016c18.752 18.752 18.752 49.12 0 67.872C696.544 907.328 684.256 912 671.968 912z" fill="#5e7a88" />
            </g>
          </g>
        </svg>
      </span>
    ...
    <div class="calendar-years" :class="{'show':yearsShow}">
      <span v-for="y in years" :class="{'active':y==year}" @click.stop="selectYear(y)">{{ y }}</span>
    </div>
...
export default {
  ...
  methods: {
    ...
    render(y, m) {
      ...
      let i; let line = 0; const temp = []; let nextMonthPushDays = 1
